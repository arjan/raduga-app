...
angular.module('app')
    ...
    .controller('PhotosCtrl', function PhotosCtrl($scope, $rootScope, $timeout, $ionicPopup, $ionicLoading, $ionicActionSheet, API, Config, Dialogs, translate) {
  ...
  .service('API', function API($http, Config) {
    ...
    return {
      ...
      getCloudsURL: function() {
        return Config.baseUrl + "/latest/clouds.png?_rnd="+Math.random();
      },
  ...
  .service('GetCitiesNearGeoLocation', function GetCityNearGeoLocation(API, Locale, Config, $rootScope, $q) {
    return function() {
      ...
      navigator.geolocation.getCurrentPosition(function(position) {
        ...
        $rootScope.$broadcast('geo', position.coords);
